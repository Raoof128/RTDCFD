...
class DetectionAgent(BaseAgent):
    ...
    def _create_detection_tools(self) -> List:
        ...
        class AnomalyDetectionInput(BaseModel):
            ...
            baseline_behavior: str = Field(description="Baseline normal behavior description")
            analysis_type: str = Field(description="Type of analysis (statistical, behavioral, signature)")
        ...
        class AnomalyDetectionTool(BaseTool):
            ...
            def _run(self, log_data: str, baseline_behavior: str, analysis_type: str) -> str:
        ...
        class IOCGenerationInput(BaseModel):
            ...
            ioc_type: str = Field(description="Type of IOC to generate (network, file, registry, behavioral)")
        ...
        class AlertCorrelationInput(BaseModel):
            ...
            correlation_method: str = Field(description="Correlation method (temporal, causal, pattern)")
        ...
        class DetectionRuleInput(BaseModel):
            threat_pattern: str = Field(description="Threat pattern or attack technique")
            rule_type: str = Field(description="Type of detection rule (sigma, yara, snort)")
        ...
        class DetectionRuleTool(BaseTool):
            ...
            def _run(self, threat_pattern: str, rule_type: str, target_platform: str) -> str:
        ...
        if result["success"]:
            ...
            self.narrative_logger.log_defense_event(
                ...
                details={
                    ...
                    "analysis_type": analysis_type,
                    "detection_summary": result["result"][:200] + "..." if len(result["result"]) > 200 else result["result"]
                }
            )
        ...
        if result["success"]:
            ...
            self.narrative_logger.log_defense_event(
                ...
                details={
                    "ioc_id": ioc_id,
                    "ioc_type": ioc_type,
                    "ioc_summary": result["result"][:200] + "..." if len(result["result"]) > 200 else result["result"]
                }
            )
    ...
    async def _handle_alert_correlation_command(self, command: Dict[str, Any]) -> None:
        ...
        correlation_id = command.get("correlation_id", f"correlation_{uuid.uuid4().hex[:8]}")
        ...
        if result["success"]:
            ...
            self.narrative_logger.log_defense_event(
                ...
                details={
                    ...
                    "correlation_method": correlation_method,
                    "correlation_summary": result["result"][:200] + "..." if len(result["result"]) > 200 else result["result"]
                }
            )
        ...
        if result["success"]:
            ...
            self.narrative_logger.log_defense_event(
                ...
                details={
                    ...
                    "threat_pattern": threat_pattern,
                    "rule_type": rule_type,
                    "rule_summary": result["result"][:200] + "..." if len(result["result"]) > 200 else result["result"]
                }
            )
    ...
    def get_detection_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "mitre_techniques_covered": list(set([
