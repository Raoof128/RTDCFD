...
class ReconAgent(BaseAgent):
    ...
    def _create_recon_tools(self) -> List:
        ...
        class OSINTGatherInput(BaseModel):
            ...
            information_type: str = Field(description="Type of information to gather (company, person, technology)")
        ...
        class VulnerabilityScanInput(BaseModel):
            ...
            scan_level: str = Field(description="Scan intensity (light, medium, comprehensive)")
        ...
        class AssetEnumerationInput(BaseModel):
            ...
            enumeration_type: str = Field(description="Type of enumeration (subdomains, technologies, employees)")
    ...
    async def _handle_osint_command(self, command: Dict[str, Any]) -> None:
        ...
        if result["success"]:
            ...
            self.narrative_logger.log_attack_event(
                ...
                target=target,
                success=True,
                details={"information_type": information_type, "findings": result["result"]}
            )
    ...
    async def _handle_asset_enumeration_command(self, command: Dict[str, Any]) -> None:
        ...
        if result["success"]:
            ...
            self.narrative_logger.log_attack_event(
                ...
                target=domain,
                success=True,
                details={"enumeration_type": enumeration_type, "assets": result["result"]}
            )
