...
class SOCIWaterSystemScenario:
    ...
    def _define_critical_assets(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "distribution_control_system": {
                ...
                "vulnerabilities": ["communication_vulnerabilities", "access_control_issues"],
            ...
            "customer_billing_system": {
                ...
                "vulnerabilities": ["web_application_vulnerabilities", "database_issues"],
            ...
            "reservoir_level_control": {
                ...
                "vulnerabilities": ["remote_access_vulnerabilities", "protocol_weaknesses"],
    ...
    def _define_attack_vectors(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "indicators": ["sensor_data_anomalies", "quality_reading_inconsistencies"],
    ...
    def _define_defensive_measures(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "implementation": ["safety_instrumented_systems", "redundant_sensors", "emergency_stops"],
                "effectiveness": "high",
            ...
            },
            {
                ...
                "implementation": ["system_backups", "recovery_procedures", "failover_systems"],
            ...
            },
            {
                ...
                "implementation": ["access_control", "surveillance", "intrusion_detection"],
                "effectiveness": "high",
    ...
    def validate_scenario(self) -> Dict[str, Any]:
        ...
        water_assets = [asset for asset in self.critical_assets.values() 
                       if asset.get("type") in ["industrial_control_system", "control_system", "monitoring_system"]]
        
        if len(water_assets) < 4:
            validation_results["warnings"].append("Limited water treatment-specific assets")
        ...
        safety_critical_assets = [asset for asset in self.critical_assets.values() 
                                if asset.get("criticality") == "critical"]
        
        if len(safety_critical_assets) < 3:
            validation_results["recommendations"].append("Expand safety-critical asset coverage")
        
        # Check for process safety controls
        process_safety_measures = [measure for measure in self.defensive_measures 
                                  if "safety" in measure.get("name", "").lower()]
        
        if len(process_safety_measures) < 2:
            validation_results["recommendations"].append("Add more process safety controls")
